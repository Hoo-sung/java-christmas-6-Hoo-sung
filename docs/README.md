...
> [기능] 평일 할인을 받는지 체크하는 기능<br>
> [기능] 평일 할인 금액을 계산하는 기능<br>
> [기능] 주말 할인을 받는지 체크하는 기능<br>
> [기능] 주말 할인 금액을 체크하는 기능<br>
> [기능] 특별 할인을 받을 수 있는지 체크하는 기능<br>
> [기능] 증정 이벤트를 받을 수 있는지 체크하는 기능<br>
> [기능] 증정 메뉴를 생성하는 기능<br>
> [기능] 혜택 내역에 할인 이벤트 내역을 기록하는 기능<br>
> [기능] 혜택 내역을 바탕으로 총혜택 금액을 계산하는 기능<br>
